...
public class StudentSignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel2);
        jLabel2.setBounds(0, 170, 108, 15);
        jPanel2.add(txtUsername);
        txtUsername.setBounds(120, 170, 210, 20);
        jPanel2.add(txtPassword);
        txtPassword.setBounds(120, 210, 210, 20);

        jLabel3.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel3.setText("PASSWORD:");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(30, 210, 72, 20);
        ...
        jPanel2.add(jPanel4);
        jPanel4.setBounds(230, 240, 100, 30);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 444, Short.MAX_VALUE)
    ...
    private void btnSigninActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSigninActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "SELECT STUDENTNUMBER, PASSWORD FROM STUDENT WHERE STUDENTNUMBER = '"
            ...
            if(rs.next()){
                if(txtPassword.getText().equals(rs.getString("PASSWORD"))){
                    ...
                    si.setVisible(true);
                    si.lblStudentno.setText(txtUsername.getText().trim());
                    this.dispose();
                }
                else{
