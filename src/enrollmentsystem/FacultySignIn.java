 ...
 * @author natha
 */
public class FacultySignIn extends javax.swing.JFrame {

    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement ps = null;
    /**
     * Creates new form FacultySignIn
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/enrollmentsystem/Pictures/faculty.png"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(110, 250, 230, 90);
        ...
        txtFacultyname.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        jPanel2.add(txtFacultyname);
        txtFacultyname.setBounds(100, 170, 202, 20);
        jPanel2.add(txtPassword);
        txtPassword.setBounds(100, 210, 202, 20);

        jLabel3.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel3.setText("PASSWORD:");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(20, 210, 80, 15);

        jLabel2.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel2.setText("FACULTY ID:");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(20, 170, 80, 15);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(120, 60, 170, 70);
        ...
        jPanel2.add(jPanel4);
        jPanel4.setBounds(200, 250, 100, 30);
    ...
    private void btnSigninActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSigninActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "SELECT * FROM FACULTY WHERE FACULTY = '"
                    +txtFacultyname.getText().trim()+"'";
            ...
            if(rs.next()){
                if(txtPassword.getText().equals(rs.getString("PASSWORD"))){
                    ...
                    fs.setVisible(true);
                    fs.lblFaculty.setText(txtFacultyname.getText().trim());
                    this.dispose();
                }
                else{
                    JOptionPane.showMessageDialog(null, "Invalid Faculty ID or Password");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacultySignIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacultySignIn().setVisible(true);
            }
        });
    }
